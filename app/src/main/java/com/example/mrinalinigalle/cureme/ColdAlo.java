...
public class ColdAlo extends AppCompatActivity {

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_cold_alo);
        ...
        viewPager.setAdapter(new ColdAloTabPager(getSupportFragmentManager()));
