...
public class EarInfectHomeo extends AppCompatActivity {

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_ear_infect_homeo);
        ...
        viewPager.setAdapter(new EarInfectHomeoTabPager(getSupportFragmentManager()));
