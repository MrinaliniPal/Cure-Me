 ...
 */
public class TensionAloTabPager extends FragmentPagerAdapter {

    public TensionAloTabPager(FragmentManager supportFragmentManager) {
    ...
    public Fragment getItem(int position) {
        if (position == 0) {
            return new TensionAloFrag1();
        } else if (position == 1) {
            return new TensionAloFrag2();
        }
