 ...
 */
public class EarInfectTabPager extends FragmentPagerAdapter {

    public EarInfectTabPager(FragmentManager supportFragmentManager) {
    ...
    public Fragment getItem(int position) {
        if(position == 0){
            return new EarInfectFrag1();
        } else if(position == 1) {
            return new EarInfectFrag2();
        } else if(position == 2) {
            return new EarInfectFrag3();
        }
