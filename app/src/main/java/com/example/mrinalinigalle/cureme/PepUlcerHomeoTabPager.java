 ...
 */
public class PepUlcerHomeoTabPager extends FragmentPagerAdapter {
    public PepUlcerHomeoTabPager(FragmentManager supportFragmentManager) {
    ...
    public Fragment getItem(int position) {
        if (position == 0) {
            return new PepUlcerHomeoFrag1();
        } else if (position == 1) {
            return new PepUlcerHomeoFrag2();
        }
