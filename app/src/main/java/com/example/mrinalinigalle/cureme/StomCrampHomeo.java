...
public class StomCrampHomeo extends AppCompatActivity {

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_stom_cramp_homeo);
        ...
        viewPager.setAdapter(new StomCrampHomeoTabPager(getSupportFragmentManager()));
