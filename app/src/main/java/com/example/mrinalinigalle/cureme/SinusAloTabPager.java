 ...
 */
public class SinusAloTabPager extends FragmentPagerAdapter {

    public SinusAloTabPager(FragmentManager supportFragmentManager) {
    ...
    public Fragment getItem(int position) {
        if (position == 0) {
            return new SinusAloFrag1();
        } else if (position == 1) {
            return new SinusAloFrag2();
        }
