...
public class SinusHomeo extends AppCompatActivity {

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_sinus_homeo);
        ...
        viewPager.setAdapter(new SinusHomeoTabPager(getSupportFragmentManager()));
