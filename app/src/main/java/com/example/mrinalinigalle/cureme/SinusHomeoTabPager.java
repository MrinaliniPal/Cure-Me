 ...
 */
public class SinusHomeoTabPager extends FragmentPagerAdapter {
    public SinusHomeoTabPager(FragmentManager supportFragmentManager) {
    ...
    public Fragment getItem(int position) {
        if (position == 0) {
            return new SinusHomeoFrag1();
        } else if (position == 1) {
            return new SinusHomeoFrag2();
        }
