...
public class ColdHomeo extends AppCompatActivity {

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_cold_homeo);
        ...
        viewPager.setAdapter(new ColdHomeoTabPager(getSupportFragmentManager()));
