 ...
 */
public class PepUlcerAloTabPager extends FragmentPagerAdapter {

    public PepUlcerAloTabPager(FragmentManager supportFragmentManager) {
    ...
    public Fragment getItem(int position) {
        if (position == 0) {
            return new PepUlcerAloFrag1();
        } else if (position == 1) {
            return new PepUlcerAloFrag2();
        }
