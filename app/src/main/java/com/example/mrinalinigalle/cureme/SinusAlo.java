...
public class SinusAlo extends AppCompatActivity {

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_sinus_alo);
        ...
        viewPager.setAdapter(new SinusAloTabPager(getSupportFragmentManager()));
