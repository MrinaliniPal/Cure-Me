 ...
 */
public class EarInfectAloTabPager extends FragmentPagerAdapter {

    public EarInfectAloTabPager(FragmentManager supportFragmentManager) {
    ...
    public Fragment getItem(int position) {
        if (position == 0) {
            return new EarInfectAloFrag1();
        } else if (position == 1) {
            return new EarInfectAloFrag2();
        }
