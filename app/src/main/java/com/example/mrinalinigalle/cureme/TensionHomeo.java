...
public class TensionHomeo extends AppCompatActivity {

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_tension_homeo);
        ...
        viewPager.setAdapter(new TensionHomeoTabPager(getSupportFragmentManager()));
