...
public class PepUlcerHomeo extends AppCompatActivity {

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_pep_ulcer_homeo);
        ...
        viewPager.setAdapter(new PepUlcerHomeoTabPager(getSupportFragmentManager()));
