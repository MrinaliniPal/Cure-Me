...
public class TensionAlo extends AppCompatActivity {

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_tension_alo);
        ...
        viewPager.setAdapter(new TensionAloTabPager(getSupportFragmentManager()));
