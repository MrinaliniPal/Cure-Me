...
public class Tension extends AppCompatActivity
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        viewPager.setAdapter(new TensionTabPager(getSupportFragmentManager()));
    ...
    public boolean onNavigationItemSelected(MenuItem item) {
        ...
        if (id == R.id.Homeo) {
            Intent g = new Intent(this,TensionHomeo.class);
            startActivity(g);


        } else if (id == R.id.Alo) {
            Intent g = new Intent(this,TensionAlo.class);
            startActivity(g);
