...
public class PepUlcerAlo extends AppCompatActivity {

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_pep_ulcer_alo);
        ...
        viewPager.setAdapter(new PepUlcerAloTabPager(getSupportFragmentManager()));
