 ...
 */
public class StomCrampHomeoTabPager extends FragmentPagerAdapter {
    public StomCrampHomeoTabPager(FragmentManager supportFragmentManager) {
    ...
    public Fragment getItem(int position) {
        if (position == 0) {
            return new StomCrampHomeoFrag1();
        } else if (position == 1) {
            return new StomCrampHomeoFrag2();
        }
