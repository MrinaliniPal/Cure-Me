 ...
 */
public class EarInfectHomeoTabPager extends FragmentPagerAdapter {
    public EarInfectHomeoTabPager(FragmentManager supportFragmentManager) {
    ...
    public Fragment getItem(int position) {
        if (position == 0) {
            return new EarInfectHomeoFrag1();
        } else if (position == 1) {
            return new EarInfectHomeoFrag2();
        }
