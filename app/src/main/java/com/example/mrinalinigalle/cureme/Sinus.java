...
public class Sinus extends AppCompatActivity
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        viewPager.setAdapter(new SinusTabPager(getSupportFragmentManager()));
    ...
    public boolean onCreateOptionsMenu(Menu menu) {
        ...
        getMenuInflater().inflate(R.menu.sinus, menu);
        return true;
    }
    ...
    public boolean onNavigationItemSelected(MenuItem item) {
        ...
        if (id == R.id.Homeo) {
            Intent g = new Intent(this,SinusHomeo.class);
            startActivity(g);


        } else if (id == R.id.Alo) {
            Intent g = new Intent(this,SinusAlo.class);
            startActivity(g);
