 ...
 */
public class ColdHomeoTabPager extends FragmentPagerAdapter {
    public ColdHomeoTabPager(FragmentManager supportFragmentManager) {
    ...
    public Fragment getItem(int position) {
        if (position == 0) {
            return new ColdHomeoFrag1();
        } else if (position == 1) {
            return new ColdHomeoFrag2();
        }
